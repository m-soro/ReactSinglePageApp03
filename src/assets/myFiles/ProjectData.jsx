export const ProjectData = [
  ...
  {
    id: 2,
    projectName: "Gourmet Store",
    images: [
      "https://github.com/m-soro/ReactSinglePageApp03/blob/main/src/assets/images/ocans02.png?raw=true",
      "https://github.com/m-soro/ReactSinglePageApp03/blob/main/src/assets/images/ocans01.png?raw=true",
    ],
